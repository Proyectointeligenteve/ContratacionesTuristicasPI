<%@ Page Title="" Language="VB" MasterPageFile="principal.master" AutoEventWireup="false" CodeFile="lst_vouchers.aspx.vb" Inherits="lst_vouchers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">       
        ...
        <div style="width: 100%">
            <span style="font-size: 14px; color: white">LISTADO DE VOUCHERS</span><hr />
        </div>
        ...
        <table id="tbDetails" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped" style ="background-color :white !important">
            <thead>
                <tr>
                    ...
                    <td  data-class="expand">AEROLINEA/HOTEL</td>
                    <td data-class="phone,tablet">RESERVA</td>
                    <td data-class="phone,tablet">FECHA ENTRADA</td>
                    <td data-class="phone,tablet">FECHA SALIDA</td>
    ...
    <script type="text/javascript" language="javascript" src="js/lst_vouchers.js"></script>
    <script>
