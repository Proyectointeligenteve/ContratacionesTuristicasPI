...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="remodal" data-remodal-id="modal">
        ...
        <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">Formulario de formas_pagos</h4>
        </div>
   ...
   <div class="remodal" data-remodal-id="msjModal">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="formas_pagosLista()">Ok</button>
            </div>
        </div> 
    <script type="text/javascript" language="javascript" src="js/lst_formas_pagos.js?token=<% Response.Write(Replace(Format(Date.Now, "yyyyMMddHH:mm:ss"), ":", ""))%>"></script>
    <script>
