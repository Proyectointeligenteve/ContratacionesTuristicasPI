<%@ Page Title="" Language="VB" MasterPageFile="principal.master" AutoEventWireup="false" CodeFile="lst_recibos.aspx.vb" Inherits="lst_recibos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <div style="width: 100%">
            <span style="font-size: 14px; color: white">LISTADO DE RECIBOS</span><hr />
        </div>
        ...
        <table id="tbDetails" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped" style ="background-color :white !important">
            <thead>
                <tr>
                    ...
                    <td data-class="phone,tablet">MONTO</td>
                    <td data-class="phone,tablet">CONCEPTO</td>
    ...
    <script type="text/javascript" language="javascript" src="js/lst_recibos.js"></script>
    <script>
