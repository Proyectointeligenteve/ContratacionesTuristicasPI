...
Partial Class lst_ventas
    Inherits System.Web.UI.Page
    Dim obj_Session As cls_Sesion
    Dim obj_marca As cls_ventas
    ...
    Sub Permisos()
        ...
        Try
            ...
            obj_sb.Append("," & Chr(34) & "Agregar" & Chr(34) & ":" & Chr(34) & IIf(New cls_permisos(obj_Session.Usuario.Id, New cls_modulos("ventas").Id, New cls_acciones("agregar").Id).permiso, 1, 0) & Chr(34) & "")
            obj_sb.Append("," & Chr(34) & "Ver" & Chr(34) & ":" & Chr(34) & IIf(New cls_permisos(obj_Session.Usuario.Id, New cls_modulos("ventas").Id, New cls_acciones("ver").Id).permiso, 1, 0) & Chr(34) & "")
            obj_sb.Append("," & Chr(34) & "Editar" & Chr(34) & ":" & Chr(34) & IIf(New cls_permisos(obj_Session.Usuario.Id, New cls_modulos("ventas").Id, New cls_acciones("editar").Id).permiso, 1, 0) & Chr(34) & "")
            obj_sb.Append("," & Chr(34) & "Anular" & Chr(34) & ":" & Chr(34) & IIf(New cls_permisos(obj_Session.Usuario.Id, New cls_modulos("ventas").Id, New cls_acciones("anular").Id).permiso, 1, 0) & Chr(34) & "")
            'obj_sb.Append("," & Chr(34) & "Eliminar" & Chr(34) & ":" & Chr(34) & IIf(New cls_permisos(obj_Session.Usuario.Id, New cls_modulos("ventas").Id, New cls_acciones("eliminar").Id).permiso, 1, 0) & Chr(34) & "")
    ...
    Sub Cargar()
        ...
        If var_estatus = 1 Then
            obj_dt_int = cls_ventas.ConsultaActivos(var_error)
        ElseIf var_estatus = 2 Then
            obj_dt_int = cls_ventas.ConsultaAnulados(var_error)
        Else
            obj_dt_int = cls_ventas.Consulta(var_error)
        End If
    ...
    Sub Anular()
        ...
        Response.ClearHeaders()
        Response.ClearContent()
        If Not cls_ventas.Anular(CInt(var_data("id").ToString), obj_Session.Usuario.Id, var_error) Then
            Response.Write("{" & Chr(34) & "rslt" & Chr(34) & ":" & Chr(34) & "error" & Chr(34) & "," & Chr(34) & "msj" & Chr(34) & ":" & Chr(34) & var_error & Chr(34) & "}")
        Else
