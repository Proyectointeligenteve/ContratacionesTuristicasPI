<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="lst_agencias.aspx.vb" Inherits="lst_agencias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        <div class="container">
            ...
            <div style ="width :100%">
                <div class ="row-fluid">
                    <div class="span10">
                        <span style="font-size: 14px;color:white"><b>LISTADO DE AGENCIAS</b></span>
                    </div> 
                    <div class="span2">
    ...
    <div class="container" style="margin-top: 10px">
       ...
       <div class="remodal" data-remodal-id="modal">
        <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">Formulario de agencias</h4>
        </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="row-fluid">
                        ...
                        <!--<div class="span6">
                            <label class="col-sm-2 control-label" for="Email">Email</label>
                            <div class="col-sm-10">
                                <input type="text" id="Text2" name="email" class="form-control" maxlength="150" />
                            </div>
                        </div>-->
                    </div>
