...
Public Class cls_agencias_contactos
#Region "VARIABLES"
    Dim var_Nombre_Tabla As String = "tbl_agencias_contactos"
...
#Region "FUNCIONES"
    ...
    Public Sub Cargar(ByVal var_id_int As Integer)
        ...
        If obj_dt_int.Rows.Count > 0 Then
            ...
            Me.var_id_agencia = obj_dt_int.Rows(0).Item("id_agencia")
    ...
    Public Function Actualizar(ByRef var_Error As String) As Boolean
        ...
        If Me.var_id = 0 Then   'NUEVO
            'If Not Ingresar(Me.obj_Conex_int, Me.var_Nombre_Tabla, Me.var_Campos, Sql_Texto(Me.var_nombre) & "," & Sql_Texto(Me.var_horas) & "," & Sql_Texto(Me.var_agencias_contactos, True), var_Error) Then
            If Not Ingresar(Me.obj_Conex_int, Me.var_Nombre_Tabla, Me.var_Campos, Sql_Texto(Me.var_id_agencia) & "," & Sql_Texto(Me.var_nombre) & "," & Sql_Texto(Me.var_cargo) & "," & Sql_Texto(Me.var_telefono), var_Error) Then
                Return False
                Exit Function
            End If
        ...
        ElseIf Me.var_id > 0 Then 'EDICION
            'If Not ac_Funciones.Actualizar(Me.obj_Conex_int, Me.var_Nombre_Tabla, "nombre=" & Sql_Texto(Me.var_nombre) & ", horas=" & Sql_Texto(Me.var_horas) & ", turno=" & Sql_Texto(Me.var_agencias_contactos), Me.var_Campo_Id & "=" & Me.var_id) Then
            If Not ac_Funciones.Actualizar(Me.obj_Conex_int, Me.var_Nombre_Tabla, "id_agencia=" & Sql_Texto(Me.var_id_agencia) & ",nombre=" & Sql_Texto(Me.var_nombre) & ",cargo=" & Sql_Texto(Me.var_cargo) & ",telefono=" & Sql_Texto(Me.var_telefono), Me.var_Campo_Id & "=" & Me.var_id) Then
                Return False
                Exit Function
            End If
            Return True
