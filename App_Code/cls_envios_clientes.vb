...
Public Class cls_envios_clientes
#Region "VARIABLES"
    Dim var_Nombre_Tabla As String = "tbl_envios_clientes"
...
#Region "FUNCIONES"
    ...
    Public Function ListaClientes() As DataTable
        ...
        obj_dt.Columns.Add("Identificador", GetType(System.String))
        obj_dt.Columns.Add("Telefono", GetType(System.String))
        obj_dt.Columns.Add("Email", GetType(System.String))
        Return obj_dt
    End Function
