...
Public Class cls_modulos
    ...
    Sub New(ByVal var_modulo As String)
        Cargar(var_modulo)
    End Sub

    Public Sub Cargar(ByVal var_modulo As String)
        Dim obj_dt_int As New DataTable
        obj_dt_int = Abrir_Tabla(Me.obj_Conex_int, "Select * from " & Me.var_Nombre_Tabla & " WHERE ltrim(rtrim(upper(nombre)))=" & Sql_Texto(var_modulo.ToUpper))
