...
function Permisos() {
    $.ajax({
        type: "POST",
        url: "lst_recibos.aspx?fn=permisos",
...
function CargarListados() {
    ...
    var v = $("#vista_estatus").val();
        ...
        "bProcessing": true,
        "bServerSide": false,
        "sAjaxSource": "lst_recibos.aspx?fn=cargar&v=" + v,
...
function Nuevo() {
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'frm_recibos.aspx';
}
...
function Ver() {
    ...
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'frm_recibos.aspx?id=' + id + '&v=1';
}
...
function Editar() {
    ...
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'frm_recibos.aspx?id=' + id;
}
...
function Imprimir() {
    ...
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'rpt_recibos.aspx?var_id=' + id;
}
...
function Eliminar() {
    ...
    $.ajax({
        type: "POST",
        url: "lst_recibos.aspx?fn=eliminar",
        data: '{"id":"' + id + '"}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
...
function Anular() {
    ...
    $.ajax({
        type: "POST",
        url: "lst_recibos.aspx?fn=Anular",
        data: '{"id":"' + id + '"}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
