...
function Permisos() {
    $.ajax({
        type: "POST",
        url: "lst_destinos.aspx?fn=permisos",
...
function Cargardestinos() {
    ...
    //oTable = $('#tbDetails').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "lst_destinos.aspx?fn=cargar",
        "oLanguage": {
...
function Nuevo() {
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'frm_destinos.aspx';
}
...
function Ver() {
    ...
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'frm_destinos.aspx?id=' + id + '&v=1';
}
...
function Editar() {
    ...
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'frm_destinos.aspx?id=' + id;
}
...
function Imprimir() {
    ...
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'rpt_destinos.aspx?var_id=' + id;
}
...
function Eliminar() {
    ...
    $.ajax({
        type: "POST",
        url: "lst_destinos.aspx?fn=eliminar",
        data: '{"id":"' + id + '"}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
