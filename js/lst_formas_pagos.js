...
function CargarListado() {
    ...
    tableElement.dataTable({
        "bProcessing": true,
        "bServerSide": false,
        "sAjaxSource": "lst_formas_pagos.aspx?fn=cargar&v=" + v,
...
function Editar() {
    ...
    $.ajax({
        type: "POST",
        url: "lst_formas_pagos.aspx?fn=editar",
        data: '{"id":"' + id + '"}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
...
function Guardar() {
    ...
    $.ajax({
        type: "POST",
        url: "lst_formas_pagos.aspx?fn=guardar",
...
function Anular() {
    ...
    $.ajax({
        type: "POST",
        url: "lst_formas_pagos.aspx?fn=Anular",
        data: '{"id":"' + id + '"}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
