...
function Permisos() {
    $.ajax({
        type: "POST",
        url: "lst_formas_pagos.aspx?fn=permisos",
...
function Cargarformas_pagos() {
    ...
    //oTable = $('#tbDetails').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "lst_formas_pagos.aspx?fn=cargar",
        "oLanguage": {
...
function Nuevo() {
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'frm_formas_pagos.aspx';
}
...
function Ver() {
    ...
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'frm_formas_pagos.aspx?id=' + id + '&v=1';
}
...
function Editar() {
    ...
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'frm_formas_pagos.aspx?id=' + id;
}
...
function Imprimir() {
    ...
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'rpt_formas_pagos.aspx?var_id=' + id;
}
...
function Eliminar() {
    ...
    $.ajax({
        type: "POST",
        url: "lst_formas_pagos.aspx?fn=eliminar",
        data: '{"id":"' + id + '"}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
