 ...
 */
function backToList() {
    var var_Id = $('#hdn_id_freelance').val();
    window.location.href = 'lst_freelances.aspx';
};
function load() {
    Permisos()
    ...
    $.ajax({
        type: "POST",
        url: "frm_freelances.aspx?fn=loadAll",
        data: '{"id":"' + recordId + '"}',
...
function Permisos() {
    ...
    $.ajax({
        type: "POST",
        url: "frm_freelances.aspx?fn=permisos&v=" + v,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
            $('.loading').hide()
...
function save() {
        ...
        $.ajax({
            type: "POST",
            url: "frm_freelances.aspx?fn=saveAll",
...
//}
    ...
    */
    ...
    function comisionDelete() {
        ...
        $.ajax({
            type: "POST",
            url: "frm_freelances.aspx?fn=comisionDelete",
    ...
    function comisionEdit() {
        ...
        $.ajax({
            type: "POST",
            url: "frm_freelances.aspx?fn=comisionEdit",
            data: '{"hdn_comisionId":"' + id + '"}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
    ...
    function comisionLoad() {
        ...
        pTable = $('#tbl_comision').dataTable({
            "bProcessing": true,
            "bServerSide": false,
            "sAjaxSource": "frm_freelances.aspx?fn=comisionLoad",
            "bFilter": false,
            "bLengthChange": false,
            "bPaginate": false,
            "bInfo": false,
    ...
    function comisionSave() {
        ...
        $.ajax({
            type: "POST",
            url: "frm_freelances.aspx?fn=comisionSave",
            data: JSON.stringify(record),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
    ...
    */
    ...
    function buscarFreelance() {
        ...
        $.ajax({
            type: "POST",
            url: "frm_freelances.aspx?fn=validar_freelance",
            data: '{"rif":"' + rif + '"}',
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
                ...
                if (response.rslt == 'exito') {
                    $("#Rif").val('');
                    $("#Rif").focus();
                    $("#dv_Error").html("La freelance '" + response.Nombre + "' ya esta registrado.");
                    $("#dv_Error").show();
                    setTimeout(function () { $('#dv_Error').hide(); }, 10000);
                    return false;
                }
    ...
    function CargarPaises() {
        ...
        $.ajax({
            type: "POST",
            url: "frm_freelances.aspx?fn=cargar_paises",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
    ...
    function CargarEstados() {
        ...
        $.ajax({
            type: "POST",
            url: "frm_freelances.aspx?fn=cargar_estados&p=" + p,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
                $.each(response.aaData, function (i, item) {
    ...
    function CargarCiudades() {
        ...
        $.ajax({
            type: "POST",
            url: "frm_freelances.aspx?fn=cargar_ciudades&e=" + e,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
                $.each(response.aaData, function (i, item) {
    ...
    function CargarTipos() {
        ...
        $.ajax({
            type: "POST",
            url: "frm_freelances.aspx?fn=cargar_tipos",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
                $.each(response.aaData, function (i, item) {
    ...
    function CargarAerolineas() {
        ...
        $.ajax({
            type: "POST",
            url: "frm_freelances.aspx?fn=cargar_aerolineas",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
                $.each(response.aaData, function (i, item) {
    ...
    function CargarHoteles() {
        ...
        $.ajax({
            type: "POST",
            url: "frm_freelances.aspx?fn=cargar_hoteles",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
                $.each(response.aaData, function (i, item) {
    ...
    function CargarVehiculos() {
        ...
        $.ajax({
            type: "POST",
            url: "frm_freelances.aspx?fn=cargar_vehiculos",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
                $.each(response.aaData, function (i, item) {
