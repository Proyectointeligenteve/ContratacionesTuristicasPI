...
function Permisos() {
    $.ajax({
        type: "POST",
        url: "lst_hoteles.aspx?fn=permisos",
...
function CargarListado() {
    ...
    tableElement.dataTable({
        "bProcessing": true,
        "bServerSide": false,
        "sAjaxSource": "lst_hoteles.aspx?fn=cargar&v=" + v,
...
function Nuevo() {
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'frm_hoteles.aspx';
}
// ya esta declarada debajo se deja este para cuando sea por modal
//function Editar() {
//    var id
...
//    $.ajax({
//        type: "POST",
//        url: "lst_hoteles.aspx?fn=editar",
//        data: '{"id":"' + id  + '"}',
//        contentType: "application/json; charset=utf-8",
//        dataType: "json",
//        success: function (response) {
...
function Editar() {
    ...
    $('.loading').show()
    $('.btn').hide();
    window.location.href = 'frm_hoteles.aspx?id=' + id;
}
...
function Guardar() {
        ...
        registro.Email = $('#email').val();
          ...
          $.ajax({
            type: "POST",
            url: "lst_hoteles.aspx?fn=guardar",
...
function eliminar() {
    ...
    $.ajax({
        type: "POST",
        url: "lst_hoteles.aspx?fn=eliminar",
        data: '{"id":"' + id + '"}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
...
function anular() {
    ...
    $.ajax({
        type: "POST",
        url: "lst_hoteles.aspx?fn=anular",
        data: '{"id":"' + id + '"}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
